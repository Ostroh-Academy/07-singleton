...
![image](https://github.com/Ostroh-Academy/07-signleton-AndrewYAG/assets/102692439/2435b9a7-efe7-424b-8c17-d3ee24b4c4d8)

**TrainReservationSystem**: Основний клас, який реалізує паттерн Singleton. Включає приватне поле _instance, що зберігає єдиний екземпляр класу, і приватне поле seats, яке представляє масив заброньованих місць у потязі. Містить властивість Instance з лінивим створенням об'єкту поля _instance, який повертає єдиний екземпляр класу, а також метод ReserveSeat, який дозволяє бронювати місця в потязі за їх номерами.
