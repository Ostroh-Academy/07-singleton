...
# Коротке пояснення
Ця програма на C# демонструє два шаблони Singleton: AudioSystem і Counter. Вона дозволяє користувачу обрати між ними через введення з консолі. Після вибору вона показує функціональність обраного Singleton. Singleton AudioSystem керує відтворенням звуку та його вимиканням, а Counter збільшує та виводить лічильни

# UML-діаграма
![image](https://github.com/Ostroh-Academy/07-signleton-keroNight/assets/107807003/d03bd0ab-f4a7-4c11-a861-859092beef39)
