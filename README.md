...
4 варіант
програма демонструє використання Singleton для створення одного екземпляра класу Logger, який використовується для журналювання подій у файл log.txt.

Клас Logger містить приватний статичний екземпляр instance і приватний конструктор, щоб заборонити створення екземплярів ззовні класу. Метод Instance використовується для отримання єдиного екземпляра класу Logger.

У методі Log класу Logger відбувається запис повідомлення у файл log.txt з використанням класу StreamWriter.

У методі Main створюється єдиний екземпляр Logger через виклик Logger.Instance, і за допомогою цього екземпляра виконуються записи подій у журнал.

![7](https://github.com/Ostroh-Academy/07-signleton-haletik/assets/92076714/1bff6bfd-bac1-420f-bb84-007f9d958826)
