...
Варіант 14 
1. Singleton Pattern: Забезпечує, що у системі є тільки один екземпляр класу DocumentManagementSystem, доступний через статичне властивість Instance.
2. DocumentService і UserService: Клас містить дві публічні властивості, які надають доступ до сервісів для роботи з документами та користувачами відповідно.
3. Приватний конструктор: Приватний конструктор запобігає створенню додаткових екземплярів класу ззовні, забезпечуючи, що тільки один екземпляр буде існувати.
Таким чином, DocumentManagementSystem забезпечує централізований доступ до операцій створення, редагування та управління документами і користувачами через єдиний глобальний об'єкт.
![mermaid-diagram-2024-06-03-151803](https://github.com/Ostroh-Academy/07-signleton-Viktoriia46/assets/132668579/b2c5dc7b-aa45-4f2f-b0b2-cd6f3ca41d51)
