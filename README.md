...
# Коротке пояснення
Програма використовує сінглтон для створення віртуального принтера PDF. Це означає, що можна створити лише один екземпляр цього принтера, і він доступний з будь-якої частини програми. Кожен раз, коли запитується екземпляр принтера, перевіряється, чи вже існує екземпляр. Якщо його немає, створюється новий. Таким чином, забезпечується, що в програмі завжди працює тільки один примірник принтера PDF.

# UML-діаграма
![2024-04-24_152940](https://github.com/Ostroh-Academy/07-signleton-IcticStep/assets/59373161/f28bd1bb-ce64-470f-8ff0-51a85b04e5a8)
