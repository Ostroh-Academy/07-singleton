...
<img width="232" alt="lab7" src="https://github.com/Ostroh-Academy/07-signleton-ViktoriaDenyshchuk/assets/92024304/9a017d04-60e5-489c-80b2-5c28f81040db">

У UML діаграмі представлений паттерн Singleton для класу Logger.
Logger: Клас, що відповідає за логування подій. Містить приватні статичні поля instance та lockObject, які забезпечують гарантований єдиний екземпляр класу та безпеку потоків від доступу. Має приватний конструктор, щоб уникнути створення екземплярів ззовні. Публічний статичний метод GetInstance() використовується для отримання єдиного екземпляру класу, а метод Log(string message) призначений для логування подій.
